    ...
    <>
      <header className="sticky top-0 z-30 border-b border-gray-100 bg-white/95 backdrop-blur-md">
        <div className="container-page flex h-16 items-center justify-between">
          ...
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2.5 font-bold text-gray-900 text-base tracking-tight">
          ...
          <button
            ...
            className="grid size-9 place-items-center rounded-full text-gray-600 transition hover:bg-gray-100 md:hidden"
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          <div
            ...
            aria-hidden="true"
          />
          <div className="absolute inset-x-0 top-16 animate-slide-down bg-white border-b border-gray-100 shadow-card">
